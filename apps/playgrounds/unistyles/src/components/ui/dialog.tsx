...
import { FocusScope } from "../../lib/focus/index"
import { DismissLayer } from "../../lib/overlay/index"
import { Portal } from "../../lib/portal/index"
import { composeEventHandlers } from "../../lib/press/index"
import { useScrollLock } from "../../lib/scroll-lock/index"
...
function useDialog() {
  ...
  if (!context) {
    throw new Error("Dialog components must be used within a")
  }
  return context
}
